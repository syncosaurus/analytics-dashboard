...
2. Create an `.env` file with the following environment variables and values in the root directory:
    - `CLOUDFLARE_ACCOUNT_ID`: This is the account ID associated with your Cloudflare account. For assistance finding your account ID: [link](https://developers.cloudflare.com/fundamentals/setup/find-account-and-zone-ids/)
    - `BEARER_AUTH`: This is an Cloudflare Analytics API token associated with your account. This is used to access the GraphQL Analytics API. For assistance on creating an API token: [link](https://developers.cloudflare.com/analytics/graphql-api/getting-started/authentication/api-token-auth/)
    - `X_AUTH_EMAIL`: This is the e-mail address associated with your Cloudflare account.
    - `X_AUTH_KEY`: This is your Cloudflare global API key. This is used to access the Cloudflare API. For assistance on finding your global API key: [link](https://developers.cloudflare.com/fundamentals/api/get-started/keys/)
